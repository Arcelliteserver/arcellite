...
export async function handleUpdateSettings(req: IncomingMessage, res: ServerResponse) {
  try {
    ...
    const { notificationsEnabled, autoMirroring, vaultLockdown, storageDevice,
      ...
      aiAutoRename, pdfThumbnails, videoThumbnails,
      castMode, castWebhookUrl,
    ...
    const aiLabels: Record<string, string> = {
      ...
      aiAutoRename: 'AI Auto-Rename', pdfThumbnails: 'PDF Thumbnails', videoThumbnails: 'Video Thumbnails',
      castMode: 'Cast Mode', castWebhookUrl: 'Cast Webhook URL',
